            ...
            <div className="w-full h-full grid grid-cols-8 grid-rows-1">
                <div className="col-span-1 row-span-1 bg-black">
                    <div className="w-10/12 mx-auto h-full flex flex-col gap-4 pt-4">
                        <div className={clsx("flex items-center gap-2 cursor-pointer", pathName.endsWith('/') ? "text-white" : "text-white/70 hover:text-white transition-colors")}>
                            <LayoutDashboard className={clsx("w-6 h-6")} />
                            <p className="text-lg font-redHatText font-medium">Dashboard</p>
                        </div>
                        <div className={clsx("flex items-center gap-2 cursor-pointer", pathName.endsWith('/requests') ? "text-white" : "text-white/70 hover:text-white transition-colors")}>
